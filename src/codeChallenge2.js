...
//! fill zero at start
/**
 * FillZero() takes a number and a length, and returns a string of the number padded with zeros to the
 * left until it reaches the desired length.
 * @param num - The number to be converted to a string.
 * @param len - The length of the string you want to return.
 */
const FillZero = (num, len) => num.toString().padStart(len, 'r');
